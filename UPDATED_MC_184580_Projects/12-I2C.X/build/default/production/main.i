...
void display_time(void)
{
 ...
 if (clock_reg[0] & 0x40)
 {
  if (clock_reg[0] & 0x20)
  {
   clcd_print("PM", (0xC0 + (12)));
  }
  else
  {
   clcd_print("AM", (0xC0 + (12)));
  }
 }
}
...
{
 calender_reg[0] = read_ds1307(0x06);
 calender_reg[1] = read_ds1307(0x05);
 calender_reg[2] = read_ds1307(0x04);
 calender_reg[3] = read_ds1307(0x03);
