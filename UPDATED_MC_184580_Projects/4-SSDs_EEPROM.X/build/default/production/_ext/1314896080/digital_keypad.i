# 1 "../2-Digital keypad.X/digital_keypad.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../2-Digital keypad.X/digital_keypad.c" 2
...
# 2 "../2-Digital keypad.X/digital_keypad.c" 2
# 1 "../2-Digital keypad.X/digital_keypad.h" 1
# 17 "../2-Digital keypad.X/digital_keypad.h"
void init_digital_keypad(void);
unsigned char read_digital_keypad(unsigned char detection_type);
# 3 "../2-Digital keypad.X/digital_keypad.c" 2
